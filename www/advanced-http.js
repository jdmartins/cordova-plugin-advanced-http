...
var publicInterface = {
  ...
  setSSLCertMode: function(mode, success, failure) {
    return exec(success, failure, 'CordovaHttpPlugin', 'setSSLCertMode', [
  ...
  sendRequest: function(url, options, success, failure) {
    ...
    switch (options.method) {
      ...
      case 'patch':
        var data = helpers.getProcessedData(options.data, options.serializer);
        return exec(onSuccess, onFail, 'CordovaHttpPlugin', options.method, [
          url,
          data,
          options.serializer,
          headers,
      ...
      case 'download':
        ...
        return exec(onDownloadSuccess, onFail, 'CordovaHttpPlugin', 'downloadFile', [
          url,
          options.params,
          headers,
          options.filePath,
  ...
  downloadFile: function(url, params, headers, filePath, success, failure) {
    return publicInterface.sendRequest(
      url,
      { method: 'download', params: params, headers: headers, filePath: filePath },
      success,
      failure
    );
  }
