...
class CordovaHttpUpload extends CordovaHttp implements Runnable {
    ...
    public CordovaHttpUpload(String urlString, Object params, String serializerName, JSONObject headers,
            JSONArray filePaths, String name, int timeout, CallbackContext callbackContext, Context context) {
